...
public class Ex3_array {
	public static void main(String[] args) {
		...
		int [] arr = new int[5];
		// arr은 Stack에 들어가고
		// arr = new int[5]개의 공간만큼 Heap에 확보를 한다.
		// 이 때 Heap에 주소는 5개가 확보가 된다.
		
		System.out.println(arr);
		
		// 배열의 이름을 출력하면
		// 주소값을 반환한다.
		// 이 처럼 값을 직접 배열에 저장하는 것이 아니라
		...
		// int num;
		// 어떤값을 가질지 알 수 없다.
		// 따라서 변수를 만들 때, 어떤 값이 부여되는지 쉽게 알기 위해
		// 초기값을 부여하면서 선언하도록 했다.
		
		// 배열의 경우 여러 개의 데이터를 저장하기 위해 별도의 공간이 필요하다.
		// 배열을 선언만 하고 생성하지 않았을 경우, 시스템은 배열을 만들 때 null
		// 키워드를 부여한다.
...
//		}
		// 배열을 처름 생성하면 데이터 타입별로 기본값이 주어진다.
		// 정수 : 0
		// 실수 : 0.0
		// 문자형 : ''
		// 객체형 : null
